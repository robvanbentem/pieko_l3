...
<h4>{{ __('pieko.common.admin') }} &raquo; {{ ucf(__('pieko.common.update').' '.__('pieko.model.product.singular')) }}</h4>
...
echo Form::control_group(
    ...
    Form::xlarge_text('name', Input::old('name', $product->name)),
...
echo Form::control_group(
    ...
    Form::prepend(Form::mini_text('price', Input::old('price', $product->price), array('placeholder' => '0.00')), __('pieko.currency')),
...
echo Form::control_group(
    ...
    Form::select('shop_id', $shops, Input::old('shop_id', $product->shop_id)),
