...
echo Form::control_group(
    ...
    Form::xlarge_text('name', Input::old('name', $shop->name)),
...
echo Form::control_group(
    ...
    Form::xlarge_text('name_short', Input::old('name_short', $shop->name_short)),
...
echo Form::control_group(
    ...
    Form::xlarge_text('color', Input::old('color', $shop->color)),
...
echo Form::control_group(
    ...
    Form::textarea('description', Input::old('description', $shop->description), array('style' => 'width: 400px;')),
