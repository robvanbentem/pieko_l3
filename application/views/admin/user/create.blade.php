...
<h4>{{ __('pieko.common.admin') }} &raquo; {{ ucf(__('pieko.common.create').' '.__('pieko.model.user.singular')) }}</h4>
...
echo Form::control_group(
    ...
    Form::xlarge_text('firstname', Input::old('firstname')),
...
echo Form::control_group(
    ...
    Form::xlarge_text('lastname', Input::old('lastname')),
...
echo Form::control_group(
    ...
    Form::multiselect('roles[]', $roles, Input::old('roles'))
);
